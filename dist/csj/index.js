...
var cloneValue = function cloneValue(obj) {
  ...
  if (!obj || obj === null || _typeof(obj) !== "object") return obj;
  // Handle Date
...
var Context = /*#__PURE__*/function (_SimpleEventEmitter2) {
  function Context(_defaultValue) {
    ...
    _defineProperty(_this2, "ns", void 0);
    _this2._defaultValue = _defaultValue;
    _this2.options = joinObject({
      individual: false
    }, options);
    _this2.ns = _clsHooked.default.createNamespace(_this2.constextId);
    return _this2;
  }
            ...
            case 0:
              ...
              return _context3.abrupt("return", new Promise( /*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
                  var _self$processLength$g2;
                  var result, error, length;
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      case 0:
                        result = undefined, error = undefined;
                        _context2.next = 3;
                        return self.ns.runPromise( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                          return _regeneratorRuntime().wrap(function _callee$(_context) {
                            while (1) switch (_context.prev = _context.next) {
                              case 0:
                                ...
                                _context.prev = 1;
                                _context.next = 4;
                                return Promise.race([target.apply(_this3, args)]);
                              case 4:
                      ...
                      case 3:
                        ...
                        if (length <= 1) {
                          setTimeout(function () {
                            ...
                            ((_self$events$contextI = self.events[contextId]) !== null && _self$events$contextI !== void 0 ? _self$events$contextI : []).splice(0).forEach(function (_ref4) {
